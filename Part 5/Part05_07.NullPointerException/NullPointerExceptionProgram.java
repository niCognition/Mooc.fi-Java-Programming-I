...
public class NullPointerExceptionProgram {
    ...
    public static void main(String[] args) {
        ...
        // The "lines = null" up above is the easy way to get the NullPointerException
        // I've created a Dice class and I'm now provoking a NullPointerException using the class instead
        // Just for fun
        System.out.println("");

        Dice dice = new Dice(34);
